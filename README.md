...
```javascript
import gcartesianProduct from 'https://cdn.jsdelivr.net/gh/stdlib-js/blas-ext-base-gcartesian-product@deno/mod.js';
```

You can also import the following named exports from the package:

```javascript
import { ndarray } from 'https://cdn.jsdelivr.net/gh/stdlib-js/blas-ext-base-gcartesian-product@deno/mod.js';
```
...
While [`typed array`][mdn-typed-array] views mandate a view offset based on the underlying buffer, the offset parameters support indexing semantics based on starting indices. For example, to access only the last two elements of `x`:
...
-   Depending on the environment, the typed versions ([`dcartesianProduct`][@stdlib/blas/ext/base/dcartesian-product], etc.) are likely to be significantly more performant.
...
[npm-image]: http://img.shields.io/npm/v/@stdlib/blas-ext-base-gcartesian-product.svg
[npm-url]: https://npmjs.org/package/@stdlib/blas-ext-base-gcartesian-product

[test-image]: https://github.com/stdlib-js/blas-ext-base-gcartesian-product/actions/workflows/test.yml/badge.svg?branch=main
[test-url]: https://github.com/stdlib-js/blas-ext-base-gcartesian-product/actions/workflows/test.yml?query=branch:main

[coverage-image]: https://img.shields.io/codecov/c/github/stdlib-js/blas-ext-base-gcartesian-product/main.svg
[coverage-url]: https://codecov.io/github/stdlib-js/blas-ext-base-gcartesian-product?branch=main

<!--

[dependencies-image]: https://img.shields.io/david/stdlib-js/blas-ext-base-gcartesian-product.svg
[dependencies-url]: https://david-dm.org/stdlib-js/blas-ext-base-gcartesian-product/main
...
[deno-url]: https://github.com/stdlib-js/blas-ext-base-gcartesian-product/tree/deno
[deno-readme]: https://github.com/stdlib-js/blas-ext-base-gcartesian-product/blob/deno/README.md
[umd-url]: https://github.com/stdlib-js/blas-ext-base-gcartesian-product/tree/umd
[umd-readme]: https://github.com/stdlib-js/blas-ext-base-gcartesian-product/blob/umd/README.md
[esm-url]: https://github.com/stdlib-js/blas-ext-base-gcartesian-product/tree/esm
[esm-readme]: https://github.com/stdlib-js/blas-ext-base-gcartesian-product/blob/esm/README.md
[branches-url]: https://github.com/stdlib-js/blas-ext-base-gcartesian-product/blob/main/branches.md

[stdlib-license]: https://raw.githubusercontent.com/stdlib-js/blas-ext-base-gcartesian-product/main/LICENSE
...
[@stdlib/blas/ext/base/dcartesian-product]: https://github.com/stdlib-js/blas-ext-base-dcartesian-product/tree/deno
